...
<JsEditor editorId="new-example" defaultHeight={380} initCode={`function Person(name, age) {
    // this = {};
...
<JsEditor editorId="new-try-example" defaultHeight={250} initCode={`function DemoFunc() {
